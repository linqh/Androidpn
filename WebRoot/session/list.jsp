...
<link rel="stylesheet" type="text/css" href="<c:url value='${pageContext.request.contextPath}/styles/tablesorter/style.css'/>" />
<script type="text/javascript" src="<c:url value='${pageContext.request.contextPath}/scripts/jquery.tablesorter.js'/>"></script>
</head>
			...
			<tr>
				...
				<td>
					...
					<c:when test="${sess.presence eq 'Online'}">
						<img src="${pageContext.request.contextPath}images/user-online.png" />
					</c:when>
					<c:when test="${sess.presence eq 'Offline'}">
						<img src="${pageContext.request.contextPath}images/user-offline.png" />
					</c:when>
					<c:otherwise>
						<img src="${pageContext.request.contextPath}images/user-away.png" />
					</c:otherwise>
					</c:choose>
